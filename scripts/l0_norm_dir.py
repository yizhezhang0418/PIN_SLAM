...
class denoise_l0norm:
    ...
    def estimate_normals(self, k = 20, k_out = 15):
...
if __name__ == "__main__":
    ...
    k_out = 15
    k = 25
    output_folder = f'/home/server/PIN_SLAM/data/wudasuidao/normal/10frame/ply_normalcorrect_dir_100_kout_{k_out}_knn_{k}'
    directory_path = '/home/server/PIN_SLAM/data/wudasuidao/normal/10frame/ply'
    ...
    for filename in tqdm(os.listdir(directory_path), desc="Processing files"):
        ...
        if os.path.isfile(file_path):
            with open(file_path, 'r') as file:
                ...
                op.normals = op.estimate_normals(k = k, k_out = k_out)
